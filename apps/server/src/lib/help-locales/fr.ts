      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Windows : [téléchargez l’application Pinar](https://github.com/djalmajr/pinar/releases/latest/download/win-x64-Pinar-Setup.exe) et lancez l’installateur. L’icône apparaît dans la zone de notification.",
