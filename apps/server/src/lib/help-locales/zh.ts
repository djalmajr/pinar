      ...
      sections: [
        {
          heading: "套餐形态",
          paragraphs: [
            "Free 包含永久本地使用、250 MB 云配额和30 天云保留期。Pro 仅按年计费，提供 2 GB，并在账户首次订阅时一次性提供 500 个 AI 点数。",
          ],
        },
        {
          heading: "计费与可用性",
      ...
      sections: [
        {
          heading: "配额与加购",
          paragraphs: [
            "Free 有 250 MB 基础云存储；Pro 有 2 GB。1 GB 和 5 GB 存储加购有效期为 12 个月。到期时若超过配额，上传会暂停；超额内容享有30天宽限期，并可恢复至第90天，之后才可删除。",
          ],
        },
        {
          heading: "权益过期之后",
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "未标记为永久的 Free 云会话在 30 天后便有资格被清理。超过 Free 配额的 Pro 内容在付费资格结束后遵循 30 天宽限和 90 天恢复窗口。这台电脑上的仅本地历史永远不会被远程删除。资格并不承诺立即移除。",
          ],
          bullets: [
            "当新捕获暂停时，请通过删除会话或替换过重截图来腾出空间，或购买 1 GB 或 5 GB 的十二个月加购。",
