    ...
    "copy-and-reopen": {
      ...
      sections: [
        ...
        },
        {
          heading: "录制复现步骤",
          paragraphs: [
            "在页面上打开 Pinar 时按 `G` 开始录制。工具栏会让开，并由一个小徽章显示已捕获的步骤数。像平常一样使用页面：点击、输入、按键、滚动和导航都会成为带缩略图的步骤，录制在页面切换后仍会继续。",
            "要结束录制，请重新打开 Pinar，钉住呈现问题的元素，再用 `Command/Ctrl/Alt+Enter` 复制。这些步骤会附加到该次捕获，并在查看器的「复现步骤」下显示。再次按 `G` 则会丢弃录制。在密码、银行卡等敏感字段中输入的文本永远不会被录制。",
          ],
          bullets: [
            "在查看器中，生成之前可以编辑或移除步骤。「生成步骤和测试」会写出带编号的复现步骤和一个 Playwright 测试，费用为 5 AI 积分。",
            "没有活动录制时复制的捕获不会有「复现步骤」面板。",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          heading: "套餐形态",
          paragraphs: [
            "Free 包含永久本地使用、250 MB 云配额和七天云保留期。Pro 按月或按年计费，提供 5 GB 和每月补充的 200 个不结转 AI 积分。Founder 是限量一次性群体，提供 5 GB 和 500 个初始积分；它不包含每月积分补充。",
          ],
        },
        {
          heading: "计费与可用性",
