...
const messages = {
  ...
  "pricing.lifetimeAiCredits": { en: "500 initial AI credits", pt: "500 créditos iniciais de IA", es: "500 créditos iniciales de IA", fr: "500 crédits IA initiaux", de: "500 anfängliche KI-Guthaben", zh: "500 个初始 AI 点数", ja: "初回 AI クレジット 500 点" },
