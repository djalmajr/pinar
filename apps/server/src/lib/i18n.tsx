...
const messages = {
  ...
  "dashboard.search": { en: "Search by title, URL, comments, or selectors…", pt: "Buscar por título, URL, comentários ou seletores…", es: "Buscar por título, URL, comentarios o selectores…", fr: "Rechercher par titre, URL, commentaires ou sélecteurs…", de: "Nach Titel, URL, Kommentaren oder Selektoren suchen…", zh: "按标题、URL、评论或选择器搜索…", ja: "タイトル、URL、コメント、セレクターで検索…" },
  ...
  "pricing.proYearlyDescription": { en: "Permanent retention for less than $1.60/month.", pt: "Retenção permanente por menos de US$ 1,60/mês.", es: "Retención permanente por menos de 1,60 US$/mes.", fr: "Conservation permanente pour moins de 1,60 $US/mois.", de: "Dauerhafte Aufbewahrung für weniger als 1,60 US-Dollar/Monat.", zh: "每月不到 1.60 美元即可永久保留。", ja: "月額1.60米ドル未満で永久保存。" },
  ...
  "pricing.perYear": { en: "/ year (~$1.58/mo)", pt: "/ ano (~US$ 1,58/mês)", es: "/ año (~1,58 US$/mes)", fr: "/ an (~1,58 $US/mois)", de: "/ Jahr (~1,58 US-Dollar/Monat)", zh: "/ 年（约 1.58 美元/月）", ja: "/ 年（約1.58米ドル/月）" },
  ...
  "pricing.getYearly": { en: "Get Pro Yearly — $19/yr", pt: "Assinar Pro Anual — US$ 19/ano", es: "Obtener Pro Anual — 19 US$/año", fr: "Choisir Pro Annuel — 19 $US/an", de: "Pro Jährlich — 19 US-Dollar/Jahr", zh: "购买 Pro 年付 — 19 美元/年", ja: "Pro 年払い — 年額19米ドル" },
  "pricing.getMonthly": { en: "Get Pro Monthly — $2.90/mo", pt: "Assinar Pro Mensal — US$ 2,90/mês", es: "Obtener Pro Mensual — 2,90 US$/mes", fr: "Choisir Pro Mensuel — 2,90 $US/mois", de: "Pro Monatlich — 2,90 US-Dollar/Monat", zh: "购买 Pro 月付 — 2.90 美元/月", ja: "Pro 月払い — 月額2.90米ドル" },
  ...
  "pricing.getLifetime": { en: "Get Lifetime Pro — $49", pt: "Obter Pro vitalício — US$ 49", es: "Obtener Pro vitalicio — 49 US$", fr: "Obtenir Pro à vie — 49 $US", de: "Lifetime Pro — 49 US-Dollar", zh: "购买终身 Pro — 49 美元", ja: "永久 Pro — 49米ドル" },
  ...
  "success.licenseKey": { en: "License key", pt: "Chave de licença", es: "Clave de licencia", fr: "Clé de licence", de: "Lizenzschlüssel", zh: "许可证密钥", ja: "ライセンスキー" },
  "success.issuedTo": { en: "Issued to {email}", pt: "Emitida para {email}", es: "Emitida para {email}", fr: "Émise pour {email}", de: "Ausgestellt für {email}", zh: "签发给 {email}", ja: "発行先: {email}" },
  ...
  "success.copyLicense": { en: "Copy license", pt: "Copiar licença", es: "Copiar licencia", fr: "Copier la licence", de: "Lizenz kopieren", zh: "复制许可证", ja: "ライセンスをコピー" },
  "success.openHistory": { en: "Open dashboard", pt: "Abrir painel", es: "Abrir panel", fr: "Ouvrir le tableau de bord", de: "Übersicht öffnen", zh: "打开控制面板", ja: "ダッシュボードを開く" },
