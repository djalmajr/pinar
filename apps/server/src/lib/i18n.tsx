...
const messages = {
  ...
  "app.storageUsage": { en: "{used} of {quota}", pt: "{used} de {quota}", es: "{used} de {quota}", fr: "{used} sur {quota}", de: "{used} von {quota}", zh: "{used} / {quota}", ja: "{used} / {quota}" },
  ...
  "pricing.founderIncludes": { en: "The Founder launch offer includes:", pt: "A oferta de lançamento Founder inclui:", es: "La oferta de lanzamiento Founder incluye:", fr: "L’offre de lancement Founder inclut :", de: "Das Founder-Startangebot enthält:", zh: "Founder 首发优惠包含：", ja: "Founder ローンチオファーに含まれるもの：" },
  ...
  "pricing.founderAiCredits": { en: "500 initial AI credits, without monthly refill", pt: "500 créditos iniciais de IA, sem recarga mensal", es: "500 créditos iniciales de IA, sin recarga mensual", fr: "500 crédits IA initiaux, sans recharge mensuelle", de: "500 anfängliche KI-Guthaben ohne monatliche Auffüllung", zh: "500 个初始 AI 点数，不按月补充", ja: "初回 AI クレジット 500 点（月次補充なし）" },
  ...
  "pricing.regionalBrazil": { en: "Brazil regional price", pt: "Preço regional para o Brasil", es: "Precio regional para Brasil", fr: "Tarif régional pour le Brésil", de: "Regionalpreis für Brasilien", zh: "巴西地区价格", ja: "ブラジル地域価格" },
