...
const locale = {
  ui: {
    ...
    next: "Siguiente",
    pageDescription:
      "Cada nota corresponde a una versión publicada o preparada para el próximo lanzamiento, sin mezclar trabajo fuera de ese alcance.",
  ...
  releases: {
    ...
    "v0.4.2": {
      ...
      summary:
        "La extensión ya no muestra Unauthorized cuando el navegador también tiene una sesión del sitio de Pinar.",
      changes: {
        "extension-session-isolation": {
          title: "El acceso de la extensión es independiente del sitio",
          description:
            "El almacenamiento remoto usa la credencial de la propia extensión. La sesión del sitio solo se usa cuando la extensión no envió la suya, así que un inicio de sesión antiguo del sitio no bloquea la extensión.",
        },
      },
    },
    "v0.4.1": {
    ...
    "v0.4.0": {
      ...
      changes: {
        "continuous-capture-session": {
          ...
          description:
            "Fija contenido en una página, sigue navegando y termina una sola vez. Pinar captura cada pin antes de navegar, conserva la numeración entre páginas y guarda todo el recorrido como una sesión, sin slots de lote.",
        },
        ...
        "founder-retired": {
          ...
          description:
            "Las nuevas compras ofrecen solo Free y Pro. Como no hay suscriptores Founder, la migración elimina la oferta y se detiene para un tratamiento explícito si encuentra una cuenta, compra, concesión, captura o reserva activa Founder inesperada.",
        },
        "element-structure": {
        ...
        "step-recording": {
          title: "Graba y organiza pasos de reproducción",
          description:
            "Pulsa G en la página para grabar clics, escritura, desplazamiento y navegación. Vuelve a abrir Pinar, fija y copia para adjuntar la línea temporal; G de nuevo la descarta. El visor convierte la grabación en pasos escritos concisos para tu agente local.",
        },
