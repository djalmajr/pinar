    ...
    "v0.3.7": {
      ...
      changes: {
        "continuous-capture-session": {
          ...
          description:
            "1ページでピン留めし、そのまま移動して最後に一度だけ完了します。Pinar は各ページを再訪してスクリーンショットを取得し、ピン番号を維持して、バッチスロットなしで全行程を1セッションに保存します。",
        },
        ...
        "founder-retired": {
          ...
          description:
            "新規購入は Free と Pro のみになりました。既存の Founder 権利は引き続き認識され、新たな Founder の約束を作らずに Pro と同じ製品機能を受け取ります。",
        },
        "element-structure": {
          title: "すべての要素ピンに構造",
          description:
