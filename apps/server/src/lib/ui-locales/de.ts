...
const messages: UiMessages = {
  ...
  "viewer.copyPage": "Seite kopieren",
  "viewer.moreActions": "Weitere Seitenaktionen",
  "viewer.viewMarkdown": "Als Markdown anzeigen",
  "viewer.openChatGPT": "In ChatGPT öffnen",
  "viewer.openClaude": "In Claude öffnen",
  ...
  "viewer.reviewPrompt": "Prüfe diese kommentierte Seite: {url}",
