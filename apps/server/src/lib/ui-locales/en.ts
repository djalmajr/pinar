const messages = {
  ...
  "viewer.copyPage": "Copy Page",
  "viewer.moreActions": "More page actions",
  "viewer.viewMarkdown": "View as Markdown",
  "viewer.openChatGPT": "Open in ChatGPT",
  "viewer.openClaude": "Open in Claude",
  "viewer.annotation": "Annotation",
  "viewer.retention": "7-day retention",
  "viewer.annotatedScreenshot": "Annotated page screenshot",
  "viewer.pinPosition": "Pin {current} of {total}",
  "viewer.nextPin": "Next pin",
  "viewer.previousPin": "Previous pin",
  ...
  "viewer.reviewPrompt": "Review this annotated page: {url}",
