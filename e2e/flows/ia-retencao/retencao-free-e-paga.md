...
name: Aplicar retenção Free e Pro cancelado
...
preconditions:
  - Sessões E2E equivalentes em instalação Free e conta Pro
...
1. Antes de sete dias, **abrir as duas sessões e seus links públicos** → todas estão disponíveis.
...
8. **Conferir coleções Free vazias** → contêineres permanecem para organização.
9. **Conferir R2/DB pela interface observável** → não há referência pública órfã.

## Expected result

Free expira após sete dias; Pro cancelado tem 90 dias de recuperação; reativação
válida remove a expiração.
