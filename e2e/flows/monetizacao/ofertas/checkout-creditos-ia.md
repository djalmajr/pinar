...
name: Comprar 500 créditos de IA
...
1. Em Plans, **localizar 500 AI credits** → R$ 9,90 e validade de 12 meses aparecem.
...
5. **Abrir uma sessão e gerar resumo** → saldo inclui 500 créditos comprados.
6. **Conferir ordem de consumo** → créditos iniciais do Pro são usados antes do pack.
7. **Reentregar webhook** → concessão não duplica.
8. **Manter plano original** → compra não altera Free/Pro.

## Expected result

O pack adiciona exatamente 500 créditos por 12 meses e preserva o plano.
