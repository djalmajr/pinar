...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    account_email_title: "Pinar Cloud account",
    account_email_description: "Create a free account or sign in with a code sent by email.",
  ...
  pt: {
    ...
    account_email_title: "Conta Pinar Cloud",
    account_email_description: "Crie uma conta gratuita ou entre com um código enviado por e-mail.",
  ...
  es: {
    ...
    account_email_title: "Cuenta Pinar Cloud",
    account_email_description: "Crea una cuenta gratuita o inicia sesión con un código por correo.",
  ...
  fr: {
    ...
    account_email_title: "Compte Pinar Cloud",
    account_email_description: "Créez un compte gratuit ou connectez-vous avec un code envoyé par e-mail.",
  ...
  de: {
    ...
    account_email_title: "Pinar Cloud-Konto",
    account_email_description: "Erstelle ein kostenloses Konto oder melde dich mit einem E-Mail-Code an.",
  ...
  zh: {
    ...
    account_email_title: "Pinar Cloud 账户",
    account_email_description: "创建免费账户或使用电子邮件验证码登录。",
  ...
  ja: {
    ...
    account_email_title: "Pinar Cloud アカウント",
    account_email_description: "無料アカウントの作成やログインには、メールで届くコードを使用します。",
