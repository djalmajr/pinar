...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    account_create_on_web: 'Create an account on the website',
  ...
  pt: {
    ...
    account_create_on_web: 'Criar conta no site',
  ...
  es: {
    ...
    account_create_on_web: 'Crear cuenta en el sitio',
  ...
  fr: {
    ...
    account_create_on_web: 'Créer un compte sur le site',
  ...
  de: {
    ...
    account_create_on_web: 'Konto auf der Website erstellen',
  ...
  zh: {
    ...
    account_create_on_web: '在网站上创建账户',
  ...
  ja: {
    ...
    account_create_on_web: 'ウェブサイトでアカウントを作成',
