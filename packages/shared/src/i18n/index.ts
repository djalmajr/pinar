...
export interface TranslationDictionary {
  overlay_session_summary: string;
  overlay_session_start: string;
  overlay_review_short: string;
  overlay_session_review: string;
  overlay_session_back: string;
  overlay_session_saved: string;
  overlay_session_captured: string;
  overlay_session_cancelled: string;
  overlay_session_pending: string;
  overlay_session_finish: string;
  overlay_session_retry: string;
  overlay_session_discard: string;
  overlay_session_remove: string;
  overlay_session_finished: string;
  overlay_session_finish_failed: string;
  ...
  local_title: string;
  local_desc: string;
  local_desc_windows: string;
  remote_title: string;
  remote_desc: string;
  staging_title: string;
  staging_desc: string;
  extension_origin_rejected: string;
  ...
  account_code_copied: string;
  account_code_empty: string;
  account_code_entry_title: string;
  account_code_expired: string;
  account_code_expires: string;
  account_code_generating: string;
  account_code_hint: string;
  ...
  overlay_voice_start: string;
  overlay_voice_stop: string;
  overlay_voice_recording: string;
  overlay_voice_duration: string;
  overlay_voice_processing: string;
  overlay_voice_transcript: string;
  overlay_voice_use_transcript: string;
  overlay_voice_ready: string;
  overlay_voice_local_only: string;
  overlay_voice_checking: string;
  overlay_voice_sign_in_required: string;
  overlay_voice_pro_required: string;
  overlay_voice_unavailable: string;
  overlay_voice_permission: string;
  overlay_voice_failed: string;
  overlay_voice_network: string;
  overlay_voice_auth: string;
  overlay_voice_credits: string;
  overlay_voice_refunded: string;
  overlay_voice_invalid: string;
  overlay_voice_acceptance: string;
  voice_settings_title: string;
  voice_settings_desc: string;
  voice_post_processing_label: string;
  voice_post_processing_desc: string;
...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    shortcuts_cancel_batch_label: "Close the session without copying",
    ...
    shortcuts_finish_batch_desc: "The first pin starts a session. Continue across pages; finish to copy all annotations together.",
    ...
    shortcuts_finish_batch_label: "Conclude and copy",
    ...
    local_desc_windows: "Everything stays 100% local and private on this device at $HOME\\.pinar\\shots.",
    remote_title: "Remote Server",
    remote_desc: "Uploads to remote server. 7-day retention. Data is never shared or sold.",
    staging_title: "Staging",
    staging_desc: "Development environment with isolated test data.",
    extension_origin_rejected: "This extension build is not authorized by the selected server.",
    ...
    account_code_copied: "Copied · single-use · expires in {time}",
    account_code_empty: "Click the key icon to generate a new code",
    account_code_entry_title: "Paste the code on Pinar's sign-in page",
    account_code_expired: "Expired · generate another code · the previous one no longer works",
    account_code_expires: "Single-use · expires in {time} · generating another invalidates this code",
    account_code_generating: "Generating a one-time code…",
    account_code_hint: "Single-use · lasts five minutes · generating another invalidates this code",
    ...
    btn_cancel: "Cancel",
    btn_generate_another_code: "Generate another code",
    ...
    btn_open_code_entry: "Open Pinar on the web",
    ...
    copy_on_finish_batch_label: "Conclude and copy",
    copy_on_finish_batch_desc: "The first pin starts a session. Continue across pages; finish to copy all annotations together.",
    ...
    voice_settings_title: "Voice comments",
    voice_settings_desc: "Transcription is available when the extension uses Pinar Cloud.",
    voice_post_processing_label: "Clean up transcription with AI",
    voice_post_processing_desc: "Remove fillers and false starts and turn the transcript into the intended comment. Off by default.",
  ...
  pt: {
    ...
    overlay_session_finished: "Sessão copiada",
    ...
    shortcuts_cancel_batch_label: "Encerrar o sessão sem copiar",
    ...
    shortcuts_finish_batch_desc: "O primeiro pin inicia uma sessão. Continue em outras páginas e conclua para copiar todas as anotações juntas.",
    ...
    shortcuts_finish_batch_label: "Concluir e copiar",
    ...
    local_desc_windows: "Tudo fica 100% local e privado neste dispositivo em $HOME\\.pinar\\shots.",
    remote_title: "Servidor Remoto",
    remote_desc: "Salva no servidor remoto. Retenção de 7 dias. Dados nunca são vendidos.",
    staging_title: "Staging",
    staging_desc: "Ambiente de desenvolvimento com dados de teste isolados.",
    extension_origin_rejected: "Esta build da extensão não está autorizada pelo servidor selecionado.",
    ...
    account_code_copied: "Copiado · uso único · expira em {time}",
    account_code_empty: "Clique no ícone de chave para gerar um código",
    account_code_entry_title: "Cole o código na tela de entrada do Pinar",
    account_code_expired: "Expirado · gere outro código · o anterior deixou de funcionar",
    account_code_expires: "Uso único · expira em {time} · gerar outro invalida este código",
    account_code_generating: "Gerando código único…",
    account_code_hint: "Uso único · válido por cinco minutos · gerar outro invalida este código",
    ...
    btn_cancel: "Cancelar",
    btn_generate_another_code: "Gerar outro código",
    ...
    btn_open_code_entry: "Abrir Pinar na web",
    ...
    copy_on_finish_batch_label: "Concluir e copiar",
    copy_on_finish_batch_desc: "O primeiro pin inicia uma sessão. Continue em outras páginas e conclua para copiar todas as anotações juntas.",
    ...
    overlay_voice_pro_required: "Comentários por voz estão incluídos no Pinar Pro. Assine para habilitá-los.",
    ...
    voice_settings_title: "Comentários por voz",
    voice_settings_desc: "A transcrição fica disponível quando a extensão usa o Pinar Cloud.",
    voice_post_processing_label: "Limpar transcrição com IA",
    voice_post_processing_desc: "Remove vícios de linguagem e falsos começos e transforma a fala no comentário pretendido. Desativado por padrão.",
  ...
  es: {
    ...
    overlay_session_finished: "Sesión copiada",
    ...
    shortcuts_cancel_batch_label: "Cerrar el sesión sin copiar",
    ...
    shortcuts_finish_batch_desc: "El primer pin inicia una sesión. Continúa en otras páginas y finaliza para copiar todas las anotaciones juntas.",
    ...
    shortcuts_finish_batch_label: "Finalizar y copiar",
    ...
    local_desc_windows: "Todo permanece 100% local y privado en este dispositivo en $HOME\\.pinar\\shots.",
    remote_title: "Servidor Remoto",
    remote_desc: "Sube al servidor remoto. Retención de 7 días. Los datos nunca se comparten.",
    staging_title: "Staging",
    staging_desc: "Entorno de desarrollo con datos de prueba aislados.",
    extension_origin_rejected: "Esta compilación de la extensión no está autorizada por el servidor seleccionado.",
    ...
    account_code_copied: "Copiado · un solo uso · caduca en {time}",
    account_code_empty: "Haz clic en el icono de llave para generar un código nuevo",
    account_code_entry_title: "Pega el código en la página de acceso de Pinar",
    account_code_expired: "Caducado · genera otro código · el anterior ya no funciona",
    account_code_expires: "Un solo uso · caduca en {time} · generar otro invalida este código",
    account_code_generating: "Generando código de un solo uso…",
    account_code_hint: "Un solo uso · válido cinco minutos · generar otro invalida este código",
    ...
    copy_on_finish_batch_label: "Finalizar y copiar",
    copy_on_finish_batch_desc: "El primer pin inicia una sesión. Continúa en otras páginas y finaliza para copiar todas las anotaciones juntas.",
    ...
    overlay_voice_pro_required: "Los comentarios de voz están incluidos en Pinar Pro. Actualiza el plan para habilitarlos.",
    ...
    voice_settings_title: "Comentarios de voz",
    voice_settings_desc: "La transcripción está disponible cuando la extensión usa Pinar Cloud.",
    voice_post_processing_label: "Limpiar la transcripción con IA",
    voice_post_processing_desc: "Elimina muletillas y falsos comienzos y convierte la transcripción en el comentario deseado. Desactivado por defecto.",
  ...
  fr: {
    ...
    overlay_session_finished: "Session copiée",
    ...
    shortcuts_cancel_batch_label: "Fermer le session sans copier",
    ...
    shortcuts_finish_batch_desc: "Le premier pin ouvre une session. Continuez sur les autres pages, puis terminez pour copier toutes les annotations.",
    ...
    shortcuts_finish_batch_label: "Terminer et copier",
    ...
    local_desc_windows: "Tout reste 100 % local et privé sur cet appareil dans $HOME\\.pinar\\shots.",
    remote_title: "Serveur Distant",
    remote_desc: "Téléverse vers le serveur distant. Rétention de 7 jours. Données jamais vendues.",
    staging_title: "Staging",
    staging_desc: "Environnement de développement avec des données de test isolées.",
    extension_origin_rejected: "Cette version de l’extension n’est pas autorisée par le serveur sélectionné.",
    ...
    account_code_copied: "Copié · usage unique · expire dans {time}",
    account_code_empty: "Cliquez sur l’icône de clé pour générer un nouveau code",
    account_code_entry_title: "Collez le code sur la page de connexion de Pinar",
    account_code_expired: "Expiré · générez un autre code · le précédent ne fonctionne plus",
    account_code_expires: "Usage unique · expire dans {time} · en générer un autre invalide ce code",
    account_code_generating: "Génération d’un code à usage unique…",
    account_code_hint: "Usage unique · valable cinq minutes · en générer un autre invalide ce code",
    ...
    btn_cancel: "Annuler",
    btn_generate_another_code: "Générer un autre code",
    ...
    btn_open_code_entry: "Ouvrir Pinar sur le web",
    ...
    copy_on_finish_batch_label: "Terminer et copier",
    copy_on_finish_batch_desc: "Le premier pin ouvre une session. Continuez sur les autres pages, puis terminez pour copier toutes les annotations.",
    ...
    overlay_voice_pro_required: "Les commentaires vocaux sont inclus dans Pinar Pro. Passez à Pro pour les activer.",
    ...
    voice_settings_title: "Commentaires vocaux",
    voice_settings_desc: "La transcription est disponible lorsque l’extension utilise Pinar Cloud.",
    voice_post_processing_label: "Nettoyer la transcription avec l’IA",
    voice_post_processing_desc: "Supprime les hésitations et faux départs et transforme la transcription en commentaire voulu. Désactivé par défaut.",
  ...
  de: {
    ...
    overlay_session_finished: "Sitzung kopiert",
    ...
    batch_finished: "Sitzung kopiert",
    ...
    shortcuts_cancel_batch_label: "Sitzung ohne Kopieren schließen",
    ...
    shortcuts_finish_batch_desc: "Der erste Pin startet eine Sitzung. Kommentieren Sie weitere Seiten und kopieren Sie am Ende alle Anmerkungen gemeinsam.",
    ...
    shortcuts_finish_batch_label: "Abschließen und kopieren",
    ...
    local_desc_windows: "Alles bleibt zu 100 % lokal und privat auf diesem Gerät unter $HOME\\.pinar\\shots.",
    remote_title: "Remote-Server",
    remote_desc: "Lädt auf den Remote-Server hoch. 7 Tage Aufbewahrung. Daten werden nie verkauft.",
    staging_title: "Staging",
    staging_desc: "Entwicklungsumgebung mit isolierten Testdaten.",
    extension_origin_rejected: "Dieser Erweiterungs-Build ist vom ausgewählten Server nicht autorisiert.",
    ...
    account_code_copied: "Kopiert · Einmalcode · läuft ab in {time}",
    account_code_empty: "Klicke auf das Schlüssel-Symbol, um einen neuen Code zu erzeugen",
    account_code_entry_title: "Füge den Code auf der Pinar-Anmeldeseite ein",
    account_code_expired: "Abgelaufen · erzeuge einen neuen Code · der vorherige gilt nicht mehr",
    account_code_expires: "Einmalcode · läuft ab in {time} · ein neuer macht diesen ungültig",
    account_code_generating: "Einmalcode wird erzeugt…",
    account_code_hint: "Einmalcode · fünf Minuten gültig · ein neuer macht diesen ungültig",
    ...
    btn_generate_another_code: "Weiteren Code erzeugen",
    ...
    btn_open_code_entry: "Pinar im Web öffnen",
    ...
    copy_on_finish_batch_label: "Abschließen und kopieren",
    copy_on_finish_batch_desc: "Der erste Pin startet eine Sitzung. Kommentieren Sie weitere Seiten und kopieren Sie am Ende alle Anmerkungen gemeinsam.",
    ...
    overlay_voice_pro_required: "Sprachkommentare sind in Pinar Pro enthalten. Führen Sie ein Upgrade durch, um sie zu aktivieren.",
    ...
    voice_settings_title: "Sprachkommentare",
    voice_settings_desc: "Die Transkription ist verfügbar, wenn die Erweiterung Pinar Cloud verwendet.",
    voice_post_processing_label: "Transkription mit KI bereinigen",
    voice_post_processing_desc: "Entfernt Füllwörter und Fehlstarts und formuliert den beabsichtigten Kommentar. Standardmäßig deaktiviert.",
  ...
  zh: {
    ...
    overlay_session_finished: "会话已复制",
    ...
    shortcuts_cancel_batch_label: "关闭会话但不复制",
    ...
    shortcuts_finish_batch_desc: "第一个标注开始会话。继续标注其他页面，完成后一起复制所有标注。",
    ...
    shortcuts_finish_batch_label: "完成并复制",
    ...
    local_desc_windows: "所有数据均 100% 保存在此设备的 $HOME\\.pinar\\shots 中，并保持私密。",
    remote_title: "远程服务器",
    remote_desc: "上传到远程服务器。7天保留期。数据从不出售。",
    staging_title: "Staging",
    staging_desc: "使用隔离测试数据的开发环境。",
    extension_origin_rejected: "所选服务器未授权此扩展构建。",
    ...
    account_code_copied: "已复制 · 一次性 · {time} 后过期",
    account_code_empty: "点击钥匙图标生成新代码",
    account_code_entry_title: "在 Pinar 登录页面粘贴代码",
    account_code_expired: "已过期 · 请生成另一个代码 · 先前的代码已失效",
    account_code_expires: "一次性 · {time} 后过期 · 生成另一个会使此代码失效",
    account_code_generating: "正在生成一次性代码…",
    account_code_hint: "一次性 · 五分钟有效 · 生成另一个会使此代码失效",
    ...
    btn_cancel: "取消",
    btn_generate_another_code: "生成另一个代码",
    btn_generate_code: "生成代码",
    btn_invalidate_and_generate: "使其失效并生成",
    btn_manage_sub: "管理订阅",
    btn_sign_out: "退出登录",
    btn_open_app: "打开应用",
    btn_open_code_entry: "在网页打开 Pinar",
    btn_copy_code: "复制代码",
    btn_send_code: "发送代码",
    btn_verify_code: "验证",
    ...
    copy_on_finish_batch_label: "完成并复制",
    copy_on_finish_batch_desc: "第一个标注开始会话。继续标注其他页面，完成后一起复制所有标注。",
    ...
    overlay_voice_pro_required: "语音评论包含在 Pinar Pro 中。升级后即可启用。",
    ...
    voice_settings_title: "语音评论",
    voice_settings_desc: "扩展使用 Pinar Cloud 时可使用转录。",
    voice_post_processing_label: "使用 AI 清理转录",
    voice_post_processing_desc: "移除口头禅和错误开头，并整理为预期评论。默认关闭。",
  ...
  ja: {
    ...
    overlay_session_finished: "セッションをコピーしました",
    ...
    shortcuts_cancel_batch_label: "コピーせずにセッションを終了",
    ...
    shortcuts_finish_batch_desc: "最初のピンでセッションが始まります。他のページでも続けて、最後にすべての注釈をコピーします。",
    ...
    shortcuts_finish_batch_label: "完了してコピー",
    ...
    local_desc_windows: "すべてのデータはこのデバイスの $HOME\\.pinar\\shots にのみ保存され、完全に非公開です。",
    remote_title: "リモートサーバー",
    remote_desc: "リモートサーバーに保存。7日間の保持期間。データは共有・販売されません。",
    staging_title: "Staging",
    staging_desc: "分離されたテストデータを使用する開発環境です。",
    extension_origin_rejected: "この拡張機能ビルドは選択したサーバーで許可されていません。",
    ...
    account_code_copied: "コピー済み · 1回限り · 残り {time}",
    account_code_empty: "鍵アイコンをクリックして新しいコードを生成",
    account_code_entry_title: "Pinar のサインインページにコードを貼り付けます",
    account_code_expired: "期限切れ · 別のコードを生成してください · 前のコードは使えません",
    account_code_expires: "1回限り · 残り {time} · 別のコードを生成するとこのコードは無効になります",
    account_code_generating: "1回限りのコードを生成しています…",
    account_code_hint: "1回限り · 5分間有効 · 別のコードを生成するとこのコードは無効になります",
    ...
    btn_sign_out: "ログアウト",
    btn_open_app: "アプリを開く",
    btn_open_code_entry: "ウェブで Pinar を開く",
    ...
    copy_on_finish_batch_label: "完了してコピー",
    copy_on_finish_batch_desc: "最初のピンでセッションが始まります。他のページでも続けて、最後にすべての注釈をコピーします。",
    ...
    overlay_voice_pro_required: "音声コメントは Pinar Pro に含まれています。アップグレードして有効にしてください。",
    ...
    voice_settings_title: "音声コメント",
    voice_settings_desc: "拡張機能が Pinar Cloud を使用しているときに文字起こしを利用できます。",
    voice_post_processing_label: "AI で文字起こしを整える",
    voice_post_processing_desc: "言いよどみや言い直しを除き、意図したコメントに整えます。既定ではオフです。",
