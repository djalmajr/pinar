...
export interface TranslationDictionary {
  ...
  overlay_cloud_subscription_required: string;
  ...
  account_session_loading: string;
  account_trial_active: string;
  account_trial_until: string;
  account_trial_expired_title: string;
  account_trial_expired: string;
  account_trial_subscribe: string;
  ...
  handoff_batch_full_context: string;
...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    remote_desc: "Uploads to remote server. 30-day retention. Data is never shared or sold.",
    ...
    account_subscription_prompt_description: "Upgrade to Pro for more storage and features.",
    ...
    account_session_loading: "Loading your account…",
    account_trial_active: "Cloud trial",
    account_trial_until: "Cloud trial until {date}",
    account_trial_expired_title: "Cloud trial ended",
    account_trial_expired: "New Cloud captures require Pro. Earlier captures stay available.",
    account_trial_subscribe: "Subscribe",
    ...
    handoff_batch_full_context: "Full context by page (open only if the details below are insufficient):",
  ...
  pt: {
    ...
    remote_desc: "Salva no servidor remoto. Retenção de 30 dias. Dados nunca são vendidos.",
    staging_title: "Staging",
    ...
    account_subscription_prompt_description: "Assine o Pro para ter mais armazenamento e recursos.",
    ...
    account_session_loading: "Carregando sua conta…",
    ...
    account_trial_expired: "Novas capturas Cloud exigem o Pro. As capturas anteriores continuam acessíveis.",
    account_trial_subscribe: "Assinar",
    ...
    handoff_batch_full_context: "Contexto completo por página (acesse apenas se os detalhes abaixo forem insuficientes):",
  ...
  es: {
    ...
    remote_title: "Servidor Remoto",
    remote_desc: "Sube al servidor remoto. Retención de 30 días. Los datos nunca se comparten.",
    staging_title: "Staging",
    ...
    account_subscription_prompt_description: "Pásate a Pro para obtener más almacenamiento y funciones.",
    ...
    account_session_loading: "Cargando tu cuenta…",
    account_trial_active: "Prueba Cloud",
    account_trial_until: "Prueba Cloud hasta el {date}",
    account_trial_expired_title: "Prueba Cloud finalizada",
    account_trial_expired: "Las nuevas capturas Cloud requieren Pro. Las capturas anteriores siguen disponibles.",
    account_trial_subscribe: "Suscribirse",
    ...
    handoff_batch_full_context: "Contexto completo por página (ábralo solo si los detalles siguientes son insuficientes):",
  ...
  fr: {
    ...
    remote_desc: "Téléverse vers le serveur distant. Rétention de 30 jours. Données jamais vendues.",
    staging_title: "Staging",
    ...
    account_subscription_prompt_description: "Passez à Pro pour plus de stockage et de fonctionnalités.",
    ...
    account_session_loading: "Chargement de votre compte…",
    account_trial_active: "Essai Cloud",
    account_trial_until: "Essai Cloud jusqu’au {date}",
    account_trial_expired_title: "Essai Cloud terminé",
    account_trial_expired: "Les nouvelles captures Cloud exigent Pro. Les captures précédentes restent accessibles.",
    account_trial_subscribe: "S’abonner",
    ...
    handoff_batch_full_context: "Contexte complet par page (ouvrez-le seulement si les détails ci-dessous sont insuffisants) :",
  ...
  de: {
    ...
    remote_title: "Remote-Server",
    remote_desc: "Lädt auf den Remote-Server hoch. 30 Tage Aufbewahrung. Daten werden nie verkauft.",
    staging_title: "Staging",
    ...
    account_subscription_prompt_description: "Mit Pro erhältst du mehr Speicherplatz und Funktionen.",
    ...
    account_session_loading: "Konto wird geladen…",
    account_trial_active: "Cloud-Test",
    account_trial_until: "Cloud-Test bis {date}",
    account_trial_expired_title: "Cloud-Test beendet",
    account_trial_expired: "Neue Cloud-Aufnahmen erfordern Pro. Frühere Aufnahmen bleiben verfügbar.",
    account_trial_subscribe: "Abonnieren",
    ...
    handoff_batch_full_context: "Vollständiger Kontext je Seite (nur öffnen, wenn die Angaben unten nicht ausreichen):",
  ...
  zh: {
    ...
    remote_title: "远程服务器",
    remote_desc: "上传到远程服务器。30天保留期。数据从不出售。",
    staging_title: "Staging",
    ...
    account_subscription_prompt_description: "升级 Pro 以获取更多存储空间和功能。",
    ...
    account_session_loading: "正在加载账户…",
    account_trial_active: "Cloud 试用",
    account_trial_until: "Cloud 试用至 {date}",
    account_trial_expired_title: "Cloud 试用已结束",
    account_trial_expired: "新的 Cloud 捕获需要 Pro。以前的捕获仍然可以访问。",
    account_trial_subscribe: "订阅",
    ...
    handoff_batch_full_context: "各页面的完整上下文（仅在下方信息不足时打开）：",
  ...
  ja: {
    ...
    remote_desc: "リモートサーバーに保存。30日間の保持期間。データは共有・販売されません。",
    staging_title: "Staging",
    ...
    account_subscription_prompt_description: "Pro にアップグレードすると、容量と機能が増えます。",
    ...
    account_session_loading: "アカウントを読み込み中…",
    account_trial_active: "Cloud トライアル",
    account_trial_until: "Cloud トライアルは {date} まで",
    account_trial_expired_title: "Cloud トライアルは終了しました",
    account_trial_expired: "新しい Cloud キャプチャには Pro が必要です。以前のキャプチャは引き続き利用できます。",
    account_trial_subscribe: "登録する",
    ...
    handoff_batch_full_context: "ページごとの完全なコンテキスト（以下の情報では不十分な場合のみ開く）:",
