...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    local_desc_windows: "Everything stays 100% local and private on this device in the user directory: .pinar\\shots\\.",
  ...
  pt: {
    ...
    local_desc_windows: "Tudo fica 100% local e privado neste dispositivo no Diretório do usuário: .pinar\\shots\\.",
  ...
  es: {
    ...
    local_desc_windows: "Todo permanece 100% local y privado en este dispositivo en el directorio del usuario: .pinar\\shots\\.",
    remote_title: "Servidor Remoto",
  ...
  fr: {
    ...
    local_desc_windows: "Tout reste 100 % local et privé sur cet appareil dans le dossier utilisateur : .pinar\\shots\\.",
  ...
  de: {
    ...
    local_desc_windows: "Alles bleibt zu 100 % lokal und privat auf diesem Gerät im Benutzerverzeichnis: .pinar\\shots\\.",
    remote_title: "Remote-Server",
  ...
  zh: {
    ...
    local_desc_windows: "所有数据均 100% 保存在此设备用户目录的 .pinar\\shots\\ 中，并保持私密。",
    remote_title: "远程服务器",
  ...
  ja: {
    ...
    local_desc_windows: "すべてのデータはこのデバイスのユーザーディレクトリ内の .pinar\\shots\\ にのみ保存され、完全に非公開です。",
