...
export const translations: Record<SupportedLanguage, TranslationDictionary> = {
  ...
  pt: {
    ...
    overlay_record_started: "Gravando passos · use a página e reabra o Pinar para marcar o resultado",
    overlay_record_cancelled: "Gravação descartada",
    overlay_recording_badge: "Pinar · gravando {count} passos · reabra o Pinar para concluir",
  ...
  es: {
    ...
    overlay_record_started: "Grabando pasos · usa la página y vuelve a abrir Pinar para marcar el resultado",
    overlay_record_cancelled: "Grabación descartada",
    overlay_recording_badge: "Pinar · grabando {count} pasos · vuelve a abrir Pinar para terminar",
  ...
  fr: {
    ...
    overlay_record_started: "Enregistrement des étapes · utilisez la page puis rouvrez Pinar pour épingler le résultat",
    overlay_record_cancelled: "Enregistrement abandonné",
    overlay_recording_badge: "Pinar · {count} étapes enregistrées · rouvrez Pinar pour terminer",
  ...
  de: {
    ...
    overlay_record_started: "Schritte werden aufgezeichnet · Seite benutzen, dann Pinar erneut öffnen und das Ergebnis pinnen",
    overlay_record_cancelled: "Aufzeichnung verworfen",
    overlay_recording_badge: "Pinar · {count} Schritte aufgezeichnet · Pinar erneut öffnen zum Abschließen",
  ...
  zh: {
    ...
    overlay_record_started: "正在录制步骤 · 操作页面后重新打开 Pinar 标注结果",
    overlay_record_cancelled: "已放弃录制",
    overlay_recording_badge: "Pinar · 已录制 {count} 个步骤 · 重新打开 Pinar 完成",
  ...
  ja: {
    ...
    overlay_record_started: "手順を記録中 · ページを操作し、Pinar を再度開いて結果にピンを打ってください",
    overlay_record_cancelled: "記録を破棄しました",
    overlay_recording_badge: "Pinar · {count} 手順を記録中 · Pinar を再度開いて完了",
