...
function DialogContent({
  ...
  ...props
}: DialogPrimitive.Popup.Props & { outsideScroll?: boolean; showCloseButton?: boolean }) {
  const popup = (
  ...
  return (
    <DialogPortal keepMounted={false}>
      <DialogOverlay />
      {outsideScroll ? (
        <DialogPrimitive.Viewport className="fixed inset-0 z-50 overflow-y-auto overscroll-contain" data-slot="dialog-viewport">
          <div className="flex min-h-full items-center justify-center p-4 sm:p-8">{popup}</div>
